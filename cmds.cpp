...
int cmdDisableClass(_In_ LPCTSTR BaseName, _In_opt_ LPCTSTR Machine, _In_ DWORD Flags, _In_ int argc, _In_reads_(argc) PTSTR argv[])
/*++
...
DispatchEntry DispatchTable[] = {
	...
	{ TEXT("disableclass"),			cmdDisableClass,		MSG_LISTCLASS_SHORT,   MSG_LISTCLASS_LONG },
